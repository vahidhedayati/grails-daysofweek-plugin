	...
	<fieldset>
		...
		<div class="weekDayContainer" >
			...
			<a class="ui-state-default ui-corner-all" id="toggleAll">
				<g:message code="all.label" locale="${instance.overrideMessageLocale?currentLocale:defaultLocale}"/></a>
			<a class="ui-state-default ui-corner-all" id="toggleNone">
				<g:message code="none.label" locale="${instance.overrideMessageLocale?currentLocale:defaultLocale}"/></a>
			<a class="ui-state-default ui-corner-all" id="toggleInvert">
				<g:message code="reverse.label" locale="${instance.overrideMessageLocale?currentLocale:defaultLocale}"/></a>
			</div>
		</div>
	</fieldset>
</div>
